...
class API(object):
    ...
    def __init__(self, main_window, api_key=None):
        self.main_window = main_window
    ...
    def searchResults(self, query, maxResults=5, order='relevance'):
        ...
        try:
            search_results = \
            self.youtube.search().list(q=query, part='id', maxResults=maxResults, order=order, type='video').execute()[
                'items']
            ...
            for result in search_results:
                ...
                entries.append(self.ydl.extract_info(link, download=False))
        except:
    ...
    def playLists(self, playlistId):
        ...
        html = self.renderResults(entries, playlist_info['title'], 2)
...
class AllVideos(QTreeView):
    ...
    def __init__(self, main_window, parent=None):
        ...
        self.main_window = main_window
        self.setGeometry(QRect(10, 20, 780, 360))
